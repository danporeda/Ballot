...
// run file from terminal with arguments 1. vote index, and 2. address of voter: yarn ts-node --files ./scripts/Vote.ts <vote> <address>
...
async function main() {
  ...
  hasVoted ? console.log('the vote has been casted') : console.log('vote has not been casted')
}
